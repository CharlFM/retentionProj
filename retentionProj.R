...
## ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
plotly::subplot(lr$ice$plots$pol_med %>% ggplotly(), lr$ice$plots$avePrice %>% ggplotly(), lr$ice$plots$Program_Code %>% ggplotly(), nrows = 1)
...
## ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
plotly::subplot(mr$ice$plots$pol_med %>% ggplotly(), mr$ice$plots$avePrice %>% ggplotly(), mr$ice$plots$Program_Code %>% ggplotly(), nrows = 1)
...
## ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
plotly::subplot(hr$ice$plots$pol_med %>% ggplotly(), hr$ice$plots$avePrice %>% ggplotly(), hr$ice$plots$Program_Code %>% ggplotly(), nrows = 1)
...
## ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
plt <- plotTarget(datIn = finDF, var_inspect = "sent_med", target = "Retained", predVar = "pred",
                  numvar = T, numVarBreaks = seq(-1, 1, 0.1),
                  autoBin = F)
plt$plt
